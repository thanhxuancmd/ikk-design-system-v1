...
export function AppleThemeProvider({
  ...
  useEffect(() => {
    ...
    root.style.setProperty('--apple-primary-soft', theme.colors.primarySoft)
    root.style.setProperty('--apple-primary-light', theme.colors.primaryLight)
    ...
    root.style.setProperty('--apple-destructive-soft', theme.colors.destructiveSoft)
    root.style.setProperty('--apple-destructive-text', theme.colors.destructiveText)
    root.style.setProperty('--apple-success', theme.colors.success)
    root.style.setProperty('--apple-success-soft', theme.colors.successSoft)
    root.style.setProperty('--apple-success-text', theme.colors.successText)
    root.style.setProperty('--apple-warning', theme.colors.warning)
    root.style.setProperty('--apple-warning-soft', theme.colors.warningSoft)
    root.style.setProperty('--apple-warning-text', theme.colors.warningText)
    root.style.setProperty('--apple-accent', theme.colors.accent)
    root.style.setProperty('--apple-accent-soft', theme.colors.accentSoft)
    root.style.setProperty('--apple-accent-text', theme.colors.accentText)
  }, [theme])
